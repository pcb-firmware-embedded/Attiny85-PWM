...
In this project, I use the ATtiny85 to control a PWM signal using a simple push button. Each time I press the button, the PWM level increases by one step, and this value is displayed on a 7-segment display. 
